		...
		<div class="row justify-content-md-center">
			<div class="card" style="width: 35rem;">
			    ...
			    <div class="card-body">
			        ...
			        ?>
					<?php echo form_open("report/save_order",['type' => 'POST','class' => 'form-horizontal']); ?>
						<div class="row">
							<div class="col-md-6 md-form">
						        <i class="fa fa-cube prefix grey-text"></i>
						        <input type="number" id="Brochure" name="Brochure" class="form-control" required>
						        <label for="Brochure">NCM Brochure</label>
						    </div>
						    <div class="col-md-5 md-form">
						        <input type="number" id="Envelope" name="Envelope" class="form-control" required>
					    ...
					    <div class="md-form">
						    ...
						    <textarea type="text" id="Comments" name="Comments" class="md-textarea"></textarea>
					    ...
					    <div class="md-form">
						    ...
						    <label class="form-check-label grey-text">
						    	<input type="checkbox" id="Network" name="Network" class="form-check-input" value="1">
						    	NCM Network
							</label>
						</div><br><br>
